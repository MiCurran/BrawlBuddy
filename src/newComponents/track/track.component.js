...
function Track(){
    ...
    const [greenScreenClasses, setGreenScreenClasses] = useState('greenScreen')
...
//1.add a checkbox for green screen stream use. if checked the background color of the component turns green screen green
     return(
       ...
       <TrackButton />
       <button onClick={() => setIsGreen(!isGreen)}>toggle Green Screen</button>
     </form>
          </div>
     <div className={`${greenScreenClasses} table-container`}>
