...
import { baseAPI } from "../../constants/api/baseApi";
import { regs } from "../../constants/constants";
            ...
            <div className="data-container">
              <div className="header rounded">
                ...
                <Row className="mt-5">
                  <Col>
                    <button
                      className="pageBtn btn btn-primary btn-sm"
